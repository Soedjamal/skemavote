  ...
  return (
    <>
      <div className="mt-4 md:px-10">
        ...
        <div className="flex flex-col pb-10 md:py-0 md:flex-row gap-10 mt-5 h-fit">
          <form
          ...
          <div className="preview flex flex-col w-full md:w-[450px] bg-neutral-300 h-[550px] rounded-xl p-5">
            ...
            <div className="flex flex-col w-full items-center mt-4">
              <h2 className="text-lg font-bold">{events[0]?.title}</h2>
